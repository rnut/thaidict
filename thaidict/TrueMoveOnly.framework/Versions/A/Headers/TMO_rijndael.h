...
int TMO_rijndaelSetupEncrypt(unsigned long *rk, const unsigned char *key,
  int keybits);
int TMO_rijndaelSetupDecrypt(unsigned long *rk, const unsigned char *key,
  int keybits);
void TMO_rijndaelEncrypt(const unsigned long *rk, int nrounds,
  const unsigned char plaintext[16], unsigned char ciphertext[16]);
void TMO_rijndaelDecrypt(const unsigned long *rk, int nrounds,
